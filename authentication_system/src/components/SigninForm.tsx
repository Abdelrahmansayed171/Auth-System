...
const SigninForm = ({children, title, subtitle}: AuthLayoutArgs) => {
  return (
      <div className='min-h-screen flex flex-col lg:flex-row bg-gray-50 dark:bg-gray-900 transition-colors'>
        <ThemeToggler/>
        <div className='hidden lg:flex lg:w-1/2 bg-blue-400 dark:bg-indigo-700 relative overflow-hidden rounded-r-4xl'>
            <img 
